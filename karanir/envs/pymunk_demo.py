...
class Game(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        #make_body(self, "crafting_table_falathrim_top.png", 40,  (floor_height + size / 2), mass = 100)
        #make_body(self, "crafting_table_house_bor_top.png", 104,  (floor_height + size / 2), mass = 4000)

        #make_body(self, "forge_petty_dwarf_front.png", 164, (floor_height + size/2), mass = 10000)

        #make_body(self, "tol_in_gaurhoth_torch.png", 600, (floor_height + size / 2), mass = 100)
        #make_body(self, "tolingaurhoth_gate_base.png", 600, (floor_height + size / 2 * 1), mass = 5000, box_shape=(32 * 4,32 * 1))
        #make_body(self, "tolingaurhoth_gate_base.png", 600, (floor_height + size / 2 * 2), mass = 5000, box_shape=(32 * 4,32 * 1))
...
class AcherusEnv(Game):
    def __init__(self,width, height, title):
        ...
        make_item(self, "cherry", 110,110);
        make_item(self, "unholy", 40,50);
        make_item(self, "diamond", 80,50);
        make_item(self, "unholy", 80, 120)
